 ...
 *
 * @link https://docs.mongodb.com/manual/reference/operator/aggregation/push/
 */
public class MongoPushApp {
  ...
  public static void main(String[] args) {
	...
	//This matchDocument is just to verify result of push for particular restaurant
